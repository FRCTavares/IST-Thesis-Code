...
def main():
    ...
    for t, msg in tracks_msgs:
        ...
        for tr in tracks:
            ...
            # Upper-body crop to reduce court/background contamination.
            # Person identity in this setup is mostly shirt/torso colour.
            bw = x2 - x1
            bh = y2 - y1
            ...
            upper_box = clamp_box(ux1, uy1, ux2, uy2, iw, ih)
