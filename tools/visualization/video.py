...
def cmd_tim_header_all(args) -> int:
    ...
    summaries = [
        render_pair(
            ...
            annotation=Path("docs/annotations/hard_reentry_header_time/bytetrack_tim_mars_final_header_time.csv"),
        ...
        render_pair(
            ...
            annotation=Path("docs/annotations/hard_reentry_header_time/ocsort_tim_mars_r1_header_time.csv"),
        ...
        render_pair(
            ...
            annotation=Path("docs/annotations/hard_reentry_header_time/deepsort_mars_target1_final_header_time.csv"),
