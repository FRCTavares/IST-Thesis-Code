...
def cmd_tim_header_all(args) -> int:
    ...
    base = Path("artifacts/bags/eval_matrix/2026-05-14__11-03-26__dataset__tim_v1_hard_reentry_id_switch_raw__tracker_ocsort__tim_off__target_1")
    ...
    summaries = [
        render_pair(
            ...
            annotation=Path("docs/data/annotations/hard_reentry_header_time/bytetrack_tim_mars_final_header_time.csv"),
        ...
        render_pair(
            ...
            annotation=Path("docs/data/annotations/hard_reentry_header_time/ocsort_tim_mars_r1_header_time.csv"),
        ...
        render_pair(
            ...
            annotation=Path("docs/data/annotations/hard_reentry_header_time/deepsort_mars_target1_final_header_time.csv"),
