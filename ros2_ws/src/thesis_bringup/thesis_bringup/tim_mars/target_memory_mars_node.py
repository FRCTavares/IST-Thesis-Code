...
class TargetMemoryMarsNode(Node):
    ...
    def _log_memory_config(self, cfg) -> None:
        self.get_logger().info(
            ...
            f"global_reacquisition_enabled="
            f"{cfg.global_reacquisition_enabled} "
            f"global_reacquisition_after_missed_frames="
            f"{cfg.global_reacquisition_after_missed_frames} "
