...
- **Comparison report:** `artifacts/reports/compare/T-33_tracker_compare_baseline_decision.md`
...
- **Ablation report:** `artifacts/reports/compare/T-33_target_selector_ablation.md`
...
- **Comparison report:** `artifacts/reports/compare/T-33_embedding_v1_compare.md`
...
- **Stability report:** `artifacts/reports/compare/T-33_control_ref_stability.md`
...
- **Latency budget report:** `artifacts/reports/timing/T-33_latency_budget.md`
...
### Tracker Comparison
- `artifacts/figures/compare/T-33_tracker_compare_track_ms_cdf.png`
- `artifacts/figures/compare/T-33_tracker_compare_reacquire_time.png`
- `artifacts/figures/compare/T-33_tracker_compare_switches.png`

### Target Selector
- `artifacts/figures/tracking/T-33_target_selector_lock_timeline.png`
- `artifacts/figures/tracking/T-33_target_selector_state_distribution.png`

### Embedding
- `artifacts/figures/tracking/T-33_embedding_v1_appearance_distance.png`
- `artifacts/figures/compare/T-33_embedding_v1_id_switches_compare.png`

### Control
- `artifacts/figures/compare/T-33_control_ref_error_distribution.png`
- `artifacts/figures/compare/T-33_control_ref_timeline.png`
- `artifacts/figures/compare/T-33_control_ref_target_valid.png`

### Latency
- `artifacts/figures/timing/T-33_latency_budget_breakdown.png`
- `artifacts/figures/timing/T-33_track_ms_cdf.png`
- `artifacts/figures/timing/T-33_latency_total_cdf.png`
...
**Post-run analysis:**
```bash
python3 tools/analyse_bag_timing.py artifacts/bags/outdoor_<scenario>_<date>/
python3 tools/analyse_bag_tracking.py artifacts/bags/outdoor_<scenario>_<date>/
python3 tools/generate_outdoor_report.py artifacts/bags/outdoor_<scenario>_<date>/ \
    --scenario <scenario> --criteria config/outdoor_success_criteria.yaml
```

**Check success:**
```bash
python3 tools/check_success.py artifacts/reports/outdoor_<scenario>_<date>.md
```
...
- `artifacts/bags/raw/2026-02-25__slice__primary/` — Primary evaluation bag
- `artifacts/bags/raw/2026-02-26__slice__longrun/` — Long-run validation
- *(Others as used)*

### T-33 Test Runs
- `artifacts/bags/T-33_clean_baseline/` — Clean scenario, baseline tracker
- `artifacts/bags/T-33_occlusion_baseline/` — Occlusion scenario
- `artifacts/bags/T-33_ambiguous_baseline/` — Multi-person crossing (if available)
- *(To be recorded)*
