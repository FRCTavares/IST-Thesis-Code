...
python3 tools/collect_live_timing_stats.py \
  ...
  --json-out "artifacts/reports/timing/ocsort_upgraded_$(date +%Y%m%d_%H%M%S).json"
```
...
python3 tools/collect_live_timing_stats.py \
  ...
  --json-out "artifacts/reports/timing/bytetrack_upgraded_$(date +%Y%m%d_%H%M%S).json"
```
...
- `artifacts/reports/timing/ocsort_upgraded_20260426_185737.json`
- `artifacts/reports/timing/bytetrack_upgraded_20260426_213133.json`
- `artifacts/reports/timing/live_benchmark_ocsort_vs_bytetrack_2026-04-26.md`
