# Daily Log — 2026-02-27 — Benchmark Harness v0, Repo Cleanup, Smoke Test Baseline (T-34, Day 4)
...
- Outputs:
  - `artifacts/reports/tracking/<eval_run>/summary.md`
...
- Rationale to write into `docs/written_logs/.../artefacts.md` tomorrow.

---

## System organisation work (today)
- Reorganised workspace layout and outputs:
  - `artifacts/bags/raw/`, `artifacts/bags/eval/`, `artifacts/reports/timing/`, `artifacts/reports/tracking/`, `artifacts/figures/timing/`
...
- Raw bag: `artifacts/bags/raw/2026-02-27__slice__smoke`
- Duration: 59.03 s
- Counts:
  - `/detections`: 1772
  - `/timing`: 1772
...
- Report: `artifacts/reports/timing/2026-02-27__slice__smoke__timing.md`
- Figures: `artifacts/figures/timing/2026-02-27__slice__smoke/`

Eval replay ran successfully and produced:
- Eval bag: `artifacts/bags/eval/2026-02-27__eval__2026-02-27__slice__smoke__sort`
- Counts:
  - `/target`: 14129
  - `/timing_tracker`: 5051
  - `/tracks`: 6774
...
- Report: `artifacts/reports/tracking/2026-02-27__eval__2026-02-27__slice__smoke__sort/summary.md`
...
BAG="$THESIS_ROOT/artifacts/bags/raw/$(date +%F)__slice__smoke"
...
cd "$THESIS_ROOT"
EVAL_BAG="$(ls -td "$THESIS_ROOT/artifacts/bags/eval/"*__eval__"$(basename "$BAG")"__sort* | head -n 1)"
