...
- **Control interface specification:** `docs/written_logs/docs/control/control_interface.md`
...
- **Lean mode specification:** `docs/written_logs/docs/lean_operational_mode.md`
...
- **Day 09 validation:** `artifacts/bags/live_camera/2026-03-09__camera_validation/`
- **Day 10 stability test:** `artifacts/bags/live_camera/2026-03-10__stability_5min/`
...
### Outdoor Test Runs
- **Day 11 first outdoor:** `artifacts/bags/outdoor/2026-03-11__first_outdoor_test/`
- **Day 12 protocol runs:** `artifacts/bags/outdoor/2026-03-12__protocol_scenarios/`
...
- **Day 13 ground demo:** `artifacts/bags/control/2026-03-13__ground_control_demo/`
- **Day 14 safety tests:** `artifacts/bags/control/2026-03-14__safety_validation/`
...
### Timing Reports
- **Live camera latency:** `artifacts/reports/timing/T-32_live_camera_latency.md`
...
- **First outdoor test:** `artifacts/reports/outdoor/T-32_first_outdoor_test.md`
  - Initial observations and issues
  - Detection quality assessment
  - Tracking performance in real-world conditions

- **Protocol execution:** `artifacts/reports/outdoor/T-32_tennis_court_scenarios.md`
...
### Control Reports
- **Control integration:** `artifacts/reports/control/T-32_control_integration.md`
  - MAVROS interface specification
  - Control message flow validation
  - Ground-based control demo results

- **Safety validation:** `artifacts/reports/control/T-32_safety_validation.md`
...
- **Flight test readiness:** `artifacts/reports/system/T-32_flight_readiness_assessment.md`
...
### Live Camera
- FPS over time: `artifacts/figures/timing/T-32_live_camera_fps_over_time.png`
- Latency breakdown: `artifacts/figures/timing/T-32_live_camera_latency_breakdown.png`
- Latency CDF comparison: `artifacts/figures/timing/T-32_live_vs_file_latency_cdf.png`

### Outdoor Tests
- Detection rate vs. distance: `artifacts/figures/outdoor/T-32_detection_vs_distance.png`
- Tracking continuity: `artifacts/figures/outdoor/T-32_tracking_continuity.png`
- Reacquisition time histogram: `artifacts/figures/outdoor/T-32_reacquisition_histogram.png`
- ID switch comparison: `artifacts/figures/outdoor/T-32_id_switches.png`

### Control
- Control update rate: `artifacts/figures/control/T-32_control_update_rate.png`
- Command latency: `artifacts/figures/control/T-32_command_latency.png`
- Safety trigger events: `artifacts/figures/control/T-32_safety_events.png`
