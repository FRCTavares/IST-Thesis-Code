...
**Control testing:**
- Replayed bag `artifacts/bags/tmp/2026-03-13__cmd_mirror_check` (297 s) with `enable_mavros:=true` and mirror topic remapped to `/mavros_mock/setpoint_velocity/cmd_vel`
