...
- [ ] Save: `artifacts/reports/system/T-32_indoor_baseline_validation.md`
...
**Deliverables:**
- `artifacts/reports/system/T-32_system_readiness.md`
...
- Optional standalone note in `artifacts/reports/system/`
