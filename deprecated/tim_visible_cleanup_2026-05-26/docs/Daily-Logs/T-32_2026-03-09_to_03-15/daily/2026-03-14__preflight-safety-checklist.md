...
**Constraints today:**
- ❌ No outdoor testing (Pi5 at home, Pixhawk at IST  until T-31)
- ✅ Complete indoor validation possible
- ✅ Finalize all T-31 preparation tasks

**Focus:** Complete indoor baseline validation and finalize T-31 field logistics
...
- [ ] Record bag: `artifacts/bags/live_camera/2026-03-14__indoor_multiperson/`
...
- [ ] Save report: `artifacts/reports/system/T-32_indoor_baseline_validation.md`
...
ros2 bag record --storage mcap \
  -o ../artifacts/bags/live_camera/2026-03-14__indoor_multiperson \
...
python tools/analyse_bag_timing.py artifacts/bags/live_camera/2026-03-12__indoor_baseline_10min
python tools/analyse_bag_timing.py artifacts/bags/live_camera/2026-03-13__indoor_extended_15min  
python tools/analyse_bag_timing.py artifacts/bags/live_camera/2026-03-14__indoor_multiperson

# Generate plots and statistics
# Save to artifacts/reports/system/T-32_indoor_baseline_validation.md
```
...
**T-31 readiness:** _(high / medium / low)_
...
This day log has been updated with implementation work completed after T-32 close, during final operational hardening.
...
- [ ] Then back inward
- [ ] Record short bag: `artifacts/bags/live_camera/2026-03-14__outdoor__scenario1__single_distance`
...
- [ ] Record short bag: `artifacts/bags/live_camera/2026-03-14__outdoor__scenario2__two_people`
