...
- **Safety checklist:** `Written Logs/T-32_2026-03-09_to_03-15/supervisor_questions.md`
...
- **Tuesday session report:** `reports/system/T-31_tuesday_mavros_integration.md`
...
- **Session report:** `reports/system/T-31_thursday_session.md`
...
### T-31 Summary
- **Final report:** `reports/system/T-31_integration_week_summary.md`
...
- Setpoint rate over time: `figures/control/T-31_setpoint_rate.png`
- Command values over time: `figures/control/T-31_command_values.png`
- Target → setpoint correlation: `figures/control/T-31_target_setpoint_correlation.png`

### Outdoor Performance (if applicable)
- Detection rate vs distance: `figures/outdoor/T-31_detection_vs_distance.png`
- FPS over time outdoor: `figures/outdoor/T-31_outdoor_fps.png`
- Outdoor vs indoor latency: `figures/outdoor/T-31_outdoor_vs_indoor_latency.png`
