# Week 10 Artefacts (2026-03-03 to 2026-03-09)

## Overview
This document tracks all deliverables, code, configurations, reports, and datasets produced during Week 10.

**Week 10 theme:** From "baseline working" to "demo-ready system with frozen configuration"
...
- **Comparison report:** `reports/compare/W10_tracker_compare_baseline_decision.md`
...
### Tracker Comparison
- `figures/compare/W10_tracker_compare_track_ms_cdf.png`
- `figures/compare/W10_tracker_compare_reacquire_time.png`
- `figures/compare/W10_tracker_compare_switches.png`

### Target Selector
- `figures/tracking/W10_target_selector_lock_timeline.png`
- `figures/tracking/W10_target_selector_state_distribution.png`

### Embedding
- `figures/tracking/W10_embedding_v1_appearance_distance.png`
- `figures/compare/W10_embedding_v1_id_switches_compare.png`

### Control
- `figures/compare/W10_control_ref_error_distribution.png`
- `figures/compare/W10_control_ref_timeline.png`
- `figures/compare/W10_control_ref_target_valid.png`

### Latency
- `figures/timing/W10_latency_budget_breakdown.png`
- `figures/timing/W10_track_ms_cdf.png`
- `figures/timing/W10_latency_total_cdf.png`
...
### Evaluation Bags (from Week 9, reused)
- `bags/raw/2026-02-25__slice__primary/` — Primary evaluation bag
- `bags/raw/2026-02-26__slice__longrun/` — Long-run validation
- *(Others as used)*

### Week 10 Test Runs
- `bags/W10_clean_baseline/` — Clean scenario, baseline tracker
- `bags/W10_occlusion_baseline/` — Occlusion scenario
- `bags/W10_ambiguous_baseline/` — Multi-person crossing (if available)
- *(To be recorded)*
...
- Previous week: [W09 artefacts](../W09_2026-02-24_to_03-02/artefacts.md)
- Next week: [W11 artefacts](../W11_2026-03-10_to_03-16/artefacts.md) (to be created)
