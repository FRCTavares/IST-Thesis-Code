...
- Added fresh comparison artifacts in `reports/timing/fresh_cmp_20260418_135742__*.json` and post-refactor artifacts in `reports/timing/live_post_refactor/*.json`.
