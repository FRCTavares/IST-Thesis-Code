# Daily Log — 2026-03-11 — First Outdoor Perception Test
...
- Decision: are we ready for full protocol execution (Day 12) or do we need fixes?
...
| Previous validation | Indoor stability confirmed on Day 10 |
...
- [ ] Power on and launch full ROS pipeline
...
- [ ] Record bag: `bags/outdoor/2026-03-11__scenario1_single_distance/`
...
- [ ] Record bag: `bags/outdoor/2026-03-11__scenario2_two_people/`
...
- [ ] Record bag: `bags/outdoor/2026-03-11__scenario3_three_people_occlusion/`
...
- [ ] Record bag: `bags/outdoor/2026-03-11__scenario4_dynamic_motion/`
...
**Tasks:**
- [ ] Copy all bags to lab storage: `bags/outdoor/2026-03-11__first_outdoor_test/`
...
### F) Assess Readiness for Full Protocol (Day 12)
...
- [ ] Decide: GO for Day 12 protocol or fix issues first?
- [ ] If fixes needed: prioritize and plan

**Deliverables:**
- GO/NO-GO decision for Day 12 outdoor protocol
- Issues list with severity
- Day 12 plan (protocol execution or fixes)
