...
timeout -s SIGINT 75s ros2 launch thesis_bringup eval_replay_ambiguous.launch.py \
  bag:="$THESIS_ROOT/bags/raw/2026-02-28__slice__smoke2" tracker:=sort window_start_s:=5.0 window_len_s:=10.0 swap_y:=false
```
...
- Occlusion comparison: `../../reports/compare/2026-03-01__occlusion_compare.md`
- Ambiguity comparison: `../../reports/compare/2026-03-01__ambiguity_compare.md`
