...
- Bag: artifacts/bags/live_camera/2026-04-29__10-17-39__video__day29_fresh_smoke
- Overlay video: artifacts/reports/videos/day29_fresh_smoke_720p.mp4

### Single-person recorded tests

Recorded bags:

- artifacts/bags/live_camera/2026-04-29__10-26-03__video__clean_walk_yolov6n_ocsort
- artifacts/bags/live_camera/2026-04-29__10-28-08__video__single_person_occlusion_yolov6n_ocsort
- artifacts/bags/live_camera/2026-04-29__10-30-08__video__fov_exit_reentry_yolov6n_ocsort

Rendered overlays:

- artifacts/reports/videos/2026-04-29__10-26-03__video__clean_walk_yolov6n_ocsort__overlay_720p.mp4
- artifacts/reports/videos/2026-04-29__10-28-08__video__single_person_occlusion_yolov6n_ocsort__overlay_720p.mp4
- artifacts/reports/videos/2026-04-29__10-30-08__video__fov_exit_reentry_yolov6n_ocsort__overlay_720p.mp4
...
- data/datasets/external/visdrone2019-mot/raw/
- data/datasets/external/visdrone2019-mot/extracted/
- data/datasets/processed/visdrone2019-mot/

Scripts added:

- `tools/data/datasets/inspect_visdrone_mot.py` — dataset inspection report
- `tools/data/datasets/render_visdrone_gt_preview.py` — GT preview rendering
- `tools/data/datasets/export_visdrone_person_mot.py` — export to MOT format
- `tools/data/datasets/evaluate_mot_predictions.py` — lightweight MOT evaluator
...
- GT preview images written to `artifacts/reports/dataset_checks/visdrone_gt_preview/` and visually validated.
- Exported MOT data: `data/datasets/processed/visdrone2019-mot/person_val_mot/`.
...
Outputs: `artifacts/reports/tracking/visdrone_full_detector_sweep_20260429_131518/summary.csv`
...
- Live recordings: `artifacts/bags/live_camera/...` (day29 bags)
- Overlay videos: `artifacts/reports/videos/*overlay_720p.mp4`
- Dataset inspection: `artifacts/reports/dataset_checks/visdrone_mot_val_inspection.md`
- GT preview: `artifacts/reports/dataset_checks/visdrone_gt_preview/`
- Exported MOT: `data/datasets/processed/visdrone2019-mot/person_val_mot/`
- Full sweep summary: `artifacts/reports/tracking/visdrone_full_detector_sweep_20260429_131518/summary.csv`
- New scripts: `tools/data/datasets/*`, `tools/experiments/*`