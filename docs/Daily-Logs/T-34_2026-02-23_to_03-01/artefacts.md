...
## Bags
- `artifacts/bags/raw/2026-02-25__slice__secondary` (110 s, secondary — `/detections /tracks /target /timing`)
- `artifacts/bags/raw/2026-02-25__slice__primary` (110 s, **primary** — `/detections /tracks /target /timing`)
- `artifacts/bags/raw/2026-02-26__slice__longrun` (464.7 s, long-run looping service — same topics)

## Reports
- `artifacts/reports/timing/2026-02-26__timing_summary.md` (primary bag, n=3296)
- `artifacts/reports/timing/2026-02-26__timing_summary_secondary.md` (secondary bag)
- `artifacts/reports/timing/2026-02-26__timing_summary_longrun.md` (long-run bag, active-only)

## Figures (thesis-ready)

### Bag: 2026-02-25__slice__primary
- `artifacts/figures/timing/lat_ms_hist_2026-02-25__slice__primary.png`
- `artifacts/figures/timing/lat_ms_cdf_2026-02-25__slice__primary.png`
- `artifacts/figures/timing/loop_ms_hist_2026-02-25__slice__primary.png`
- `artifacts/figures/timing/loop_ms_cdf_2026-02-25__slice__primary.png`
- `artifacts/figures/timing/pub_dt_ms_timeseries_2026-02-25__slice__primary.png`

### Bag: 2026-02-25__slice__secondary
- `artifacts/figures/timing/lat_ms_hist_2026-02-25__slice__secondary.png`
- `artifacts/figures/timing/lat_ms_cdf_2026-02-25__slice__secondary.png`
- `artifacts/figures/timing/loop_ms_hist_2026-02-25__slice__secondary.png`
- `artifacts/figures/timing/loop_ms_cdf_2026-02-25__slice__secondary.png`
- `artifacts/figures/timing/pub_dt_ms_timeseries_2026-02-25__slice__secondary.png`
...
python3 tools/analyse_bag_timing.py artifacts/bags/raw/2026-02-25__slice__primary \
  --out artifacts/reports/timing/2026-02-26__timing_summary.md \
  --figdir figures --plot-timeseries --gap-ms 100

# Analyse long-run bag (active-only)
python3 tools/analyse_bag_timing.py artifacts/bags/raw/2026-02-26__slice__longrun \
  --out artifacts/reports/timing/2026-02-26__timing_summary_longrun.md \
  --figdir figures --plot-timeseries --gap-ms 100
