...
This document is the implementation authority for M1-v2 (schema + validator), M2-v2 (evaluator resolution + duration accounting), and M3-v2 (UI) -- all three now landed. Nothing in this document is only a comment in code -- every rule below is enforced by `tools/analysis/physical_target_reference_v2.py` and proven by `tools/tests/test_physical_target_reference_v2.py`, by `tools/analysis/physical_target_bbox_evaluation_v2.py` and `tools/tests/test_physical_target_bbox_evaluation_v2.py`, and by `tools/bag_annotation_ui/tim_ui_physical_reference_v2.py`/`tools/bag_annotation_ui/static/tim_physical_reference_v2_ui.js` and `tools/tests/test_tim_ui_physical_reference_v2.py`.
...
## N. UI expectations for M3-v2 (frozen here; landed 2026-08-10 in `tools/bag_annotation_ui/tim_ui_physical_reference_v2.py` and `tools/bag_annotation_ui/static/tim_physical_reference_v2_ui.js`, matching every point below)
