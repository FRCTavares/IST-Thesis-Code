...
**Status:** authoritative planning specification; migration not yet started.
...
Final forensic audit source:

    branch:
    issue-58-lightweight-vs-integrated

    audited HEAD:
    bbc19d2182fe0ce6322a93fc29bb88cbeb15169c

    audited origin/main:
    22b9737a868253527c14a571011b1d763fd52aa9

    merge base:
    072cb190b70f575753375ee2ca416e9cb8823e96
...
- 4 commits were unique to the audited `origin/main`;
- 40 commits were unique to the audited Issue #58 HEAD.

This divergence did not invalidate the UI audit because the
migration-sensitive trees were subsequently compared directly.

---

# 6. Cross-branch UI equivalence proof

The `live-ui` tree object was identical on the audited Issue #58 HEAD and the
audited `origin/main`.
...
- portions of coordinate-contract tests;

were attributable to later Issue #64 source-recording/evidence work and did not
change the dashboard repository ownership boundary.

Therefore this plan is valid independently of the Issue #58 scientific branch.

---

# 7. Green pre-migration functional baseline

A green baseline was established on 29 August 2026.
...
- production frontend TypeScript/Vite build: PASS;
...
No functional failure was present before migration.

This is the comparison baseline for later migration validation.

---

# 8. Frozen migration-sensitive hashes

Planning baseline hashes:
...
## Dashboard bridge
    ...
    ros2_ws/src/thesis_bringup/thesis_bringup/dashboard/dashboard_bridge_node.py
    657771e48be647ceae34b596b5530094af704e471b93d18b1b2051ce1a8e80aa
...
These hashes are planning sentinels, not permanent version pins.

At execution time:

- unchanged hashes require no renewed architecture audit;
- changed hashes trigger a targeted review of only the changed contract;
- a changed file does not automatically invalidate this plan.
