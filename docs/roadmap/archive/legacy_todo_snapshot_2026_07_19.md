# Legacy TIM-MARS roadmap snapshot

This file preserves the former root `TODO_LIST.md` exactly as it existed before
the active-queue restructuring on 19 July 2026.

It is a historical snapshot only. It contains completed work, superseded plans,
diagnostic notes, duplicated refinements, and tasks that were later migrated to
GitHub Issues.

Do not use this file to select current work.

The authoritative current queue is:

- `TODO_LIST.md`;
- the linked open GitHub Issues.
