...
1. [ ] [#51 — P2 Complete deferred physical validation for unattended Pi recovery (September)](https://github.com/FRCTavares/IST-Thesis-Code/issues/51)
   ...
   - the issue remains open for watchdog or independent-power mitigation, exact AERONEXT fallback-profile provisioning/validation, and the physical Pixhawk/field-network mode validation.
