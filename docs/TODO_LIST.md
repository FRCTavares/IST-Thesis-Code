...
**7 September TIM-MARS ablation checkpoint:** the development-only AB-11/AB-18 2x2 decomposition is complete across May, Seq01, Seq03 and Seq04. Default-off controls are semantically neutral on all four sequences. AB-11 exactly reproduces canonical behavior and workload; AB-18 exactly reproduces the selected available-image challenge. Forced fresh challenge scheduling therefore owns the selected development delta, while the later general same-ID negative veto is redundant on the permitted development evidence. Remaining Stage-1 mechanism ablations are still required before the simplification decision. H01/H02/H03 remain untouched.**
