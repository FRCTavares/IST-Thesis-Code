...
1. [ ] [#64 — Resolve high-resolution appearance crops on representative small-target UAV footage](https://github.com/FRCTavares/IST-Thesis-Code/issues/64) — FIELD DEPENDENT / #32 PREREQUISITE
   ...
   - 22 September Cell-1 VGA/TIM attempt `2026-09-22__12-30-10` remains retained and INVALID: timing/resources were healthy, but visual provenance was missing and the structured recorder reported 23 transport losses. It is not Cell-1 evidence.
