...
3. [ ] [#41 — Write explicit thesis limitations from final evidence](https://github.com/FRCTavares/IST-Thesis-Code/issues/41) — EVIDENCE DEPENDENT
   ...
   - #27 capture/annotation evidence remains frozen; #58 quantitative evidence has a completed post-access source-time comparison pending review and thesis integration. The #64 retained-resolution decision is complete; final wording still depends on #50 and #32.
