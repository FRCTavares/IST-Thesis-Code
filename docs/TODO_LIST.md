...
1. [ ] [#90 — Add long-gap global appearance-based target reacquisition](https://github.com/FRCTavares/IST-Thesis-Code/issues/90)
   - ACTIVE NOW. Issue #89 is closed and has frozen the comparison-eligible versus memory-update-eligible appearance contract. Add conservative long-gap global appearance recovery without weakening the short-gap safety path or allowing unconfirmed observations to update positive memory.
